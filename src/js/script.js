...
function lightDark(sl){
    if (sl == "sol"){
        ...
        document.querySelector("nav").style.backgroundColor = '#a1c4fd'
        document.querySelector("#comeca").style.backgroundColor = '#a1c4fd'
    ...
    if (sl == "lua"){
        ...
        document.querySelector("nav").style.backgroundColor = '#3a0202'
        document.querySelector("#comeca").style.backgroundColor = '#3a0202'
